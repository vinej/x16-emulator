> ### Fork — X16-MiSTer "VERA_2" edition
> This is a fork of **[x16community/x16-emulator](https://github.com/x16community/x16-emulator)**
> (BSD-2-Clause, © Michael Steil) that adds an optional **SDRAM-backed bitmap layer
> ("VERA_2")** at `$9F60`–`$9F6F`: a full-screen 640×480 4bpp/8bpp linear framebuffer
> composited over VERA, mirroring the same feature in the
> **[X16-MiSTer FPGA core](https://github.com/vinej/X16_Mister)**.
>
> Enable it with the **`-bitmap2`** command-line flag; without the flag the emulator
> behaves exactly like upstream. Register spec: **[vera_2.md](vera_2.md)** ·
> examples: **[demo/](demo/)**.
>
> Not real X16 hardware. Bundled `ymfm` is BSD-3-Clause (© Aaron Giles).
> **No ROM is included** — supply your own `rom.bin` (e.g. from
> [x16community/x16-rom](https://github.com/x16community/x16-rom)).
